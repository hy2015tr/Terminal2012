...
{
    public partial class  frm15_GemiYuklemeSD : Form
    {
        //-----------------------------------------------------------------------------------------------------------//
        ...
        public frm15_GemiYuklemeSD(AlfaSys p_System)
        {
            // Initialize
            InitializeComponent();
        ...
        private void frm15_GemiYuklemeSD_Load(object sender, EventArgs e)
        {
            // Page01
        ...
        {
            // BtnList
            if (tbFisNo.Text.Trim().Length > 0 && txtKonsNo.Text.Trim().Length > 0) 
        ...
        private void txtKonsNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Force UpperCase
            if (char.IsLower(e.KeyChar))
            {
                // Get Position
                int pos = txtKonsNo.SelectionStart;

                // Inseert Upper Key
                txtKonsNo.Text = txtKonsNo.Text.Insert(pos, char.ToUpper(e.KeyChar).ToString());

                // Set Position
                txtKonsNo.SelectionStart = pos + 1;
        ...
        private void tbFisNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Force UpperCase
            if (char.IsLower(e.KeyChar))
            {
                // Get Position
                int pos = tbFisNo.SelectionStart;

                // Inseert Upper Key
                tbFisNo.Text = tbFisNo.Text.Insert(pos, char.ToUpper(e.KeyChar).ToString());

                // Set Position
                tbFisNo.SelectionStart = pos + 1;
